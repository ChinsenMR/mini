...
Component({
  ...
  methods: {
    jumptap: function(e) {
      ...
      switch (linkData) {
        case 1:
          var id = this.properties.topMenuUrls.content.dataset[index].item_id
          wx.navigateTo({
        ...
        case 5:
          var id = this.properties.topMenuUrls.content.dataset[index].item_id
          var gameType = parseFloat(this.properties.topMenuUrls.content.dataset[index].gameType)
          ...
          break;
        case 6:
          var link = this.properties.topMenuUrls.content.dataset[index].wxlink
          wxltype = this.properties.topMenuUrls.content.dataset[index].wxlinkType
          if (wxltype == 1) {
            wx.switchTab({
              url: '/' + link
            })
        ...
        case 10:
          ...
          break;
        case 11:
          var link = this.properties.topMenuUrls.content.dataset[index].link
          if (link) {
            wx.navigateTo({
        ...
        case 14:
          var id = this.properties.topMenuUrls.content.dataset[index].item_id
          var wxlink = this.properties.topMenuUrls.content.dataset[index].wxlink
          wx.navigateTo({
            url: '/' + wxlink + '?id=' + id
          })
          break;
