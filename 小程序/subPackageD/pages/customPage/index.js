...
Page({
  ...
  onLoad: function (optoins) {
    ...
    this.setData({
      jsonUrl: decodeURIComponent(optoins.jsonUrl)
    })
  ...
  getData() {
    ...
    // console.log(this.data.jsonUrl, 'cust')
  ...
  jumpWhere(e) { //跳转类型跟下标
    ...
    switch (linktype) { //测试顺序按照后台配置顺序
      ...
      case 14:
        ...
        if (topicslistjson) {
          wx.redirectTo({
            url: '/subPackageD/pages/customPage/index?jsonUrl=' + topicslistjson,
          })
        }
