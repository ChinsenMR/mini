import {getStoreProductsList,getUploadStoreProduct,getHerderList,getDeleteStoreProducts,getProductsDataList} from '../../../utils/requestApi';
const app = getApp();
let timeId = -1;
...
Page({
  ...
  handleEditInfo() {
    wx.navigateTo({
      url: '../../pages/setShopInfo/setShopInfo',
    })
  },
  ...
  sharePosteCanvas: function(avaterSrc, codeSrc) {
    ...
    wx.createSelectorQuery().select('#canvas-container').boundingClientRect(function(rect) {
      ...
      if (cardInfo.StoreName) {
        ...
        ctx.setTextAlign('left');
        ctx.fillText(cardInfo.StoreName, left + 20, width + 80);
      }
      //  绘制二维码
      if (codeSrc) {
        ...
        // ctx.fillText("微信扫码或长按识别", left + 150, width + 130);
      }
    }).exec()
