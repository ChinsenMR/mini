...
module.exports = {
  ...
  openBalance(data) {
    return ajaxRequset({
      url: '/API/MembersHandler.ashx?action=OpenBalance',
      data
    }).then((res) => res)
  },
  ...
  getAppletTitle(data) {
    return ajaxRequset({
      url: '/API/WeChatApplet.ashx?action=GetAppletTitle',
      data
    }).then((res) => res)
  },
  /** 
  ...
  getUnionId(params) {
    ...
    return interceptors({
      url: '/API/PublicHandler.ashx?action=GetUnionId',
      data: params,
    });
  },
  ...
  getOpenId(data) {
    return interceptors({
      url: '/API/WeChatApplet.ashx?action=GetOpenId',
      data
    }).then((res) => res)
  },
  /* 获取分享者的openid */
  getMemberByOpenId(data) {
    return interceptors({
      url: '/API/MembersHandler.ashx?action=GetMemberByOpenId',
      data
    }).then((res) => res)
  },
  /* 登录 */
...
/**
  ...
  getSetting(data) {
		return interceptors({
			url: '/api/PublicHandler.ashx?action=GetWebSet',
			data
		}).then((res) => res);
	},
